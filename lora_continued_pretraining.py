...
# ==========================================================
# 3. Setup New LoRA for Continued Pretraining
# ==========================================================
print("Setting up new LoRA for Continued Pretraining...")
peft_config = LoraConfig(
    r=128,  
    lora_alpha=256,
    target_modules=["q_proj", "fc2", "fc1", "k_proj", "out_proj", "v_proj"],
    lora_dropout=0.05,
    bias="none",
    task_type="CAUSAL_LM"
)
...
# ==========================================================
# 4. Prepare Dataset (Chunking into continuous stream)
# ==========================================================
